...
L.PolySideLabel = L.Class.extend({
    ...
    */
    ...
    LengthUnit: function (meters) {
        var convertMeters = meters / L.GeometryUtil.ratio;
        return convertMeters > 1000 ? (convertMeters / 1000).toFixed(2) + " km" : convertMeters.toFixed(1) + " m";
    },
