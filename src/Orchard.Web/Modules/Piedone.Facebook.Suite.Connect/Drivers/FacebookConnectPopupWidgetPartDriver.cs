...
namespace Piedone.Facebook.Suite.Drivers
{
    ...
    public class FacebookConnectPopupWidgetPartDriver : ContentPartDriver<FacebookConnectPopupWidgetPart>
    {
        ...
        public FacebookConnectPopupWidgetPartDriver(
        ...
        protected override DriverResult Display(FacebookConnectPopupWidgetPart part, string displayType, dynamic shapeHelper)
        {
            return ContentShape("Parts_FacebookConnectPartPopupWidget",
                () =>
                {
                    ...
                    return shapeHelper.Parts_FacebookConnectPartPopupWidget(
        ...
        protected override DriverResult Editor(FacebookConnectPopupWidgetPart part, dynamic shapeHelper)
        {
