...
namespace Piedone.Facebook.Suite.Services
{
    ...
    public class FacebookConnectService : IFacebookConnectService
    {
        ...
        public FacebookConnectService(
            ...
            //IMembershipFrontEndService membershipfrontendService,
            ...
            IFacebookConnectEventHandler eventHandler)
        {
            ...
            //_membershipfrontendService = membershipfrontendService;
        ...
        public IFacebookUser FetchMe()
        {
            ...
            try
            {
                ...
                MailAddress addr = new MailAddress(me.email);// add by kenji nguyen
                string userName = addr.User;// add by kenji nguyen
                ...
                user.FaceBookEmail =  me.email;// add by kenji nguyen
                user.Link = me.link;
                user.FacebookUserName = me.username ?? userName;// edit by kenji nguyen
                ...
                user.IsVerified = me.verified ?? false; // Maybe it is possible that verified is set, but is false -> don't take automatically as true if it's set
        ...
        public void UpdateFacebookUser(IUser user, IFacebookUser facebookUser)
        {
            ...
            part.FaceBookEmail = facebookUser.FaceBookEmail;
        ...
        public IFacebookUser GetFacebookUser(long facebookId)
        {
            ...
            return _contentManager
                ...
                .Where(u => u.FacebookUserId == facebookId).Slice(1).FirstOrDefault<FacebookUserPart>();
        }
