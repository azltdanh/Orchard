...
namespace Piedone.Facebook.Suite.Migrations
{
    ...
    public class FacebookConnectMigrations : DataMigrationImpl
    {
        ...
        {
            SchemaBuilder.AlterTable("FacebookUserPartRecord", table => table
                .AddColumn<string>("FaceBookEmail")
             );
            return 7; ;
        }
        ...
        {
            ContentDefinitionManager.AlterTypeDefinition("FacebookConnectPopupWidget",
               cfg => cfg
                   .WithPart(typeof(FacebookConnectPopupWidgetPart).Name)
                   .WithPart("WidgetPart")
                   .WithPart("CommonPart")
                   .WithSetting("Stereotype", "Widget"));
