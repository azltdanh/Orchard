...
{
    public class PropertyAdvantagePartRecord : ContentPartRecord
    {
        ...
        public virtual double AddedValue { get; set; }
    }

    public class PropertyAdvantagePart : ContentPart<PropertyAdvantagePartRecord>
    {
        public string Name
        {
        ...
        {
            get { return Retrieve(r => r.AddedValue); }
            set { Store(r => r.AddedValue, value); }
        }
    }
}