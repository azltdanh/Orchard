...
if ($(window).width() <= 767) {
    ...
    $("select[id$=ProvinceId]").change(function () {
        if ($(this).val() > 0) {
            var slcDistrict = $("#" + this.id.replace("ProvinceId", "DistrictIds"), $(this).closest('form'));
    ...
    $("select[id$=DistrictIds]").change(function () {
        var slcWard = $("#" + this.id.replace("DistrictIds", "WardIds"), $(this).closest('form'));
        var slcStreet = $("#" + this.id.replace("DistrictIds", "StreetIds"), $(this).closest('form'));
        var slcApartment = $("#" + this.id.replace("DistrictIds", "ApartmentId"), $(this).closest('form'));
        ...
        if ($(this).val()) {
            ...
            if (slcWard.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        slcWard.empty().append("<option value=''>--Chọn tất cả phường / Xã--</option>");
            ...
            if (slcStreet.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        slcStreet.empty().append("<option value=''>--Chọn tất cả đường--</option>");
            ...
            if (slcApartment.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        slcApartment.empty().append("<option value=''>--Chọn tất cả dự án--</option>");
    ...
    $('.mobile-toggle').click(function () {
        $('.form-search-mobile').slideToggle('slow');
    });
}