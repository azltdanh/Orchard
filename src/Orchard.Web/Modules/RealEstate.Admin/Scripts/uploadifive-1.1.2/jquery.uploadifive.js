                            ...
                            xhr.addEventListener('load', function(e) {
                                if (this.readyState == 4) {
                                    ...
                                    if (this.status == 200) {
                                        ...
                                        if (file.xhr.responseText.lastIndexOf("error:", 0) !== 0) { /* ASK - FIX: a more generic approach.  adjust upload script accordingly */
                            ...
                            reader.onload = function(e) {
                                ...
                                xhr.addEventListener('load', function(e) {
                                    ...
                                    if (status == 404) {
                                        ...
                                        //if (file.xhr.responseText != 'Invalid file type.') {    
                                        if (file.xhr.responseText.lastIndexOf("error:", 0) !== 0) { /* ASK - FIX: a more generic approach.  Recommend you adjust upload script accordingly */
                                            $data.uploadComplete(e, file, uploadAll);
                                        } else {
                                            $data.error(file.xhr.responseText, file, uploadAll);
                                        } 
